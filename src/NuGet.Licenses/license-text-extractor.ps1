...
$exceptionResponseData = Invoke-RestMethod "https://raw.githubusercontent.com/spdx/license-list-data/38193d69ba3e0b9e84f94ebc23c6e3a2bd9b0bec/json/exceptions.json"
